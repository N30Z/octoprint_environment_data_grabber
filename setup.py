...
plugin_identifier = "environment_data_grabber"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_environment_data_grabber"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "environment_data_grabber"
...
# module
plugin_description = """An OctoPrint plugin to grab environmental data from a webpage and display it in the top bar."""
...
plugin_url = "https://github.com/N30Z/octoprint_environment_data_grabber"
